...
def d3pipeline(
    #cellular preprocess
    cellular_preprocess_script="python cli-pre-processing.py",
    ...
    training_datasets=json.dumps(["train", "test"]),
    training_input_dataset_mounts=json.dumps(["/opt/dkube/inputs/train/", "/opt/dkube/inputs/test"]),
    ...
    evaluation_input_dataset_mounts=json.dumps(["/opt/dkube/inputs/test/"]),
